  ...
  return (
    ...
    >
      <motion.div
        ...
        className="glass-panel-elevated rounded-3xl border border-slate-200 dark:border-slate-700 max-w-3xl w-full p-4 sm:p-6 space-y-4 sm:space-y-5 my-auto max-h-[90vh] overflow-y-auto shadow-2xl"
