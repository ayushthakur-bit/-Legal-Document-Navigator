      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 border-b border-slate-200/60 dark:border-slate-800/80">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-slate-900 via-indigo-950 to-indigo-900 text-indigo-400 flex items-center justify-center shadow-md border border-white/20 dark:border-white/10 shrink-0">
            ...
            <div className="relative ml-2 sm:ml-4 hidden md:block">
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-200 glass-subtle hover:bg-white/80 dark:hover:bg-slate-800 rounded-xl transition-all cursor-pointer max-w-[240px] border border-slate-200 dark:border-slate-700/80 hover:scale-[1.02] active:scale-[0.98]"
          ...
          {/* Right Controls: Search, Notifications, Light/Dark Toggle, New Document */}
          <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold transition-all cursor-pointer ${
                  !isDark
                    ...
                    : "text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-300/40 dark:hover:bg-slate-800/50"
                }`}
            ...
            {onOpenExportModal && (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-bold rounded-xl glass-subtle hover:bg-indigo-50 dark:hover:bg-indigo-950/50 border border-slate-200/80 dark:border-slate-700/80 text-indigo-700 dark:text-indigo-300 hover:border-indigo-300 dark:hover:border-indigo-600 shadow-xs transition-all cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 sm:px-4 py-2 text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-600 dark:hover:bg-indigo-500 rounded-xl shadow-md hover:shadow-indigo-500/20 transition-all cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
            >
        ...
        {/* Tier 2: Secondary Navigation with animated sliding pill indicator */}
